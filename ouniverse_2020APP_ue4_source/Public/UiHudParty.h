...
UCLASS()
class ETREIAAPP_API UUiHudParty : public UUserWidget
{
	GENERATED_BODY()
...
UCLASS()
class ETREIAAPP_API UUiHudPartyMember : public UUserWidget
{
	GENERATED_BODY()
...
UCLASS()
class ETREIAAPP_API UUiHudPartyMemberStyle : public UUserWidget
{
	GENERATED_BODY()
