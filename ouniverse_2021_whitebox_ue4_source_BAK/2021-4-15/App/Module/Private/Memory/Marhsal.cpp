...
void UMarshalUtil::MarshalBoolBP(FMarshal& Marshal, FString Key, bool& Bool, FMarshal& MarshalR)
{
...
void UMarshalUtil::MarshalObjectBP(FMarshal& Marshal, FString Key, FMarshal& Object, FMarshal& MarshalR)
{
...
void UMarshalUtil::MarshalDebugPrint(FMarshal& Marshal)
{
	JsonS J = JsonS();
	Marshal.M->Json(J);
