...
void AAppController::SetupInputComponent()
{
	...
	BTs[InputEnumBT::InputEnumBT_Home] = UInputButton::Create(this, &EKeys::Home, InputEnumBT::InputEnumBT_Home);
...
void AAppController::SendInputButtonEvent(UInputButton* InputButton)
{
	...
	if (InputButton->InputCode == InputEnumBT_Home && !InputButton->bPressed)
	{
