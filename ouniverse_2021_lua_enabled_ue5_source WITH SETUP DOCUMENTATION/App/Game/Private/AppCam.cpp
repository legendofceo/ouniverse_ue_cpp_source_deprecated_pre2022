...
void UCamTweenPartyShift::Setup(AAppCam* InAAppCam, FTViewTarget OutVT, UCameraComponent* InTarget, float TotalTime)
{
	CM = InAAppCam;
...
void AAppCam::ForceCameraTarget(UCameraComponent* InTarget)
{
...
void AAppCam::RunTween(UCamTweenPartyShift* InActiveTween)
{
	bIsTweening = true;
	ActiveTween = InActiveTween;
}

void AAppCam::UpdateViewTargetInternal(FTViewTarget& OutVT, float DeltaTime)
{
