...
WriMenuP::WriMenuP(int InID, WriterPro* InPro, WriLoadoutC* InWriData, AtlasLibC* InAtlasLib) : ProtocolC(InID,this)
{
	Pro_ = InPro;
	...
	WriLoadout_ = new WriFileP(Pro::PLoadout,this,Pro_,WriData_,AtlasLib_);
...
void WriMenuP::DataLoad()
{
	View_->DataLoad();
}

void WriMenuP::DataUnload()
{
	View_->DataUnload();
}