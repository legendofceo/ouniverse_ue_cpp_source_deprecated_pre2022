...
class ONE_API UEquipable : public UObject
{
	GENERATED_BODY()
...
UCLASS(Blueprintable)
class ONE_API UWearable : public UEquipable
{
	GENERATED_BODY()
...
UCLASS(Blueprintable)
class ONE_API UWearableHuman : public UWearable
{
	GENERATED_BODY()
...
UCLASS(Blueprintable)
class ONE_API UWearableNudeBust : public UWearableHuman
{
	GENERATED_BODY()
...
UCLASS(Blueprintable)
class ONE_API UWearableNudeLegs: public UWearableHuman
{
	GENERATED_BODY()
...
UCLASS(Blueprintable)
class ONE_API UWearableNudeHands : public UWearableHuman
{
	GENERATED_BODY()
...
UCLASS(Blueprintable)
class ONE_API UWearableNudeFeet : public UWearableHuman
{
	GENERATED_BODY()
