...
class ONE_API UBindSpecial : public UActorComponent
{
	GENERATED_BODY()
...
UCLASS(Blueprintable, ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class ONE_API UBindMak : public UActorComponent
{
	GENERATED_BODY()
...
UCLASS(Blueprintable, ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class ONE_API UBindPad: public UActorComponent
{
	GENERATED_BODY()
...
UCLASS(Blueprintable, ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class ONE_API UBindAxis : public UActorComponent
{
	GENERATED_BODY()
...
UCLASS(Blueprintable, ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class ONE_API UBindAxisFaux : public UActorComponent
{
	GENERATED_BODY()
